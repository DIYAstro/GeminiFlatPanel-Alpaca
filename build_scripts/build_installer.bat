...
echo --- Building Gemini Flat Panel Windows Installer ---

REM 0. Cleanup previous installer
if exist "%PROXY_ROOT%\build\GeminiFlatPanelProxy-Setup-*.exe" (
    echo [0/4] Cleaning previous installer...
    del "%PROXY_ROOT%\build\GeminiFlatPanelProxy-Setup-*.exe"
)
